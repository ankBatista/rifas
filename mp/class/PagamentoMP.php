...
class PagamentoMP
{
   ...
   private $client_id = "2361910189048781";
   private $client_secret = "Ez3BHwYroR9tZERBZDNiSXzyxTLeiyyY";
   ...
   public function PagarMP($ref, $nome, $valor, $url)
   {
      ...
      $preference_data = array(
         ...
         "back_urls" => array(
            "success" => $url . "/mp/notifica.php?success",
            "failure" => $url . "/mp/notifica.php?failure",
            "pending" => $url . "/mp/notifica.php?pending"
         ),

         "notification_url" => $url . "/mp/notifica.php",
